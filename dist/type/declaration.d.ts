...
declare module "Math/Builder/support/equation" {
    ...
    export class Equation {
        ...
        latex: string;
        dep: Variables;
        constructor(zeroFunc: Fun, latex: string, dep: Variables);
        solve(): void;
        fit(): void;
 ...
 * ```
 */
declare function OnCircle(angle: number): Point2D;
/**
 ...
 * ```
 */
declare function RndOnCircle(n: number, separation: number): Point2D[];
/**
 * @category Random
