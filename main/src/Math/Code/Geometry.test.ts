...
test('PdFoot', () => {
    expect(PdFoot([-2, 2], [[-1, -1], [1, 1]])).toBeDeepCloseTo([0, 0])
    expect(PdFoot([0, 0], [[-1, -1], [1, 1]])).toBeDeepCloseTo([0, 0])
    expect(PdFoot([2, 3], [[0, 5], [1, 5]])).toBeDeepCloseTo([2, 5])
    expect(PdFoot([2, 5], [[0, 5], [1, 5]])).toBeDeepCloseTo([2, 5])
})
