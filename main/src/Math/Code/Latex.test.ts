...
test('StemAndLeaf', () => {
    expect(StemAndLeaf({
        ...
        labels: [2, 'x', 6, 12, 14, 16, 23, 23, 24, 25, 26, 26, 'y', 26, 27, 31],
        stem: "10 units",
        leaf: "{1} unit"
    }))
        .toBe(String.raw`\begin{array}{r|l}\text{Stem} & \text{Leaf} \\ \text{10 units} & \text{{1} unit} \\ \hline 0 & { \begin{array}{} 2 & x & 6 \end{array} } \\ 1 & { \begin{array}{} 2 & 4 & 6 \end{array} } \\ 2 & { \begin{array}{} 3 & 3 & 4 & 5 & 6 & 6 & y & 6 & 7 \end{array} } \\ 3 & { \begin{array}{} 1 \end{array} } \\  \end{array}`);
});
...
test('FreqTable', () => {
    expect(FreqTable({
        ...
        dataLabel: '$x',
        freqLabel: 'count'
    })).toBe(String.raw`\begin{array}{|c|c|c|c|c|} \hline x & 1 & 2 & 3 & 4 \\  \hline \text{count} & 2 & 0 & 3 & 2 \\  \hline  \end{array}`);
