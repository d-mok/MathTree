 ...
 * ```
 */
export function IsInteger(...items) {
    return items.every($ => typeof $ === 'number' && IsNum($) && Number.isInteger($.blur()));
}
/**
 ...
 * ```
 */
export function IsDecimal(...items) {
 ...
 * ```
 */
export function IsTerminating(...items) {
    return items.every($ => typeof $ === 'number' && IsNum($) && $.sigfig() < 10);
}
/**
 ...
 * ```
 */
export function IsRational(...items) {
    return items.every($ => typeof $ === 'number' && IsNum($) && Number.isRational($));
}
/**
 ...
 * ```
 */
export function IsOdd(...items) {
    return items.every($ => typeof $ === 'number' &&
        IsInteger($) &&
        Math.abs($.blur()) % 2 === 1);
}
/**
 ...
 * ```
 */
export function IsProbability(...items) {
    return items.every($ => typeof $ === 'number' && IsNum($) && $ >= 0 && $ <= 1);
}
/**
 ...
 * ```
 */
export function IsSquareNum(...items) {
    return items.every($ => typeof $ === 'number' && IsInteger($) && IsInteger(Math.sqrt($)));
}
/**
 * check is positive.
 * ```
 ...
 * ```
 */
export function IsPositive(...items) {
 ...
 * ```
 */
export function IsNonNegative(...items) {
    return items.every($ => typeof $ === 'number' && IsNum($) && $ >= 0);
}
/**
 ...
 * ```
 */
export function IsPositiveInteger(...items) {
 ...
 * ```
 */
export function IsNonNegativeInteger(...items) {
    return items.every($ => typeof $ === 'number' && IsInteger($) && $ >= 0);
}
/**
 * check is negative.
 ...
 * ```
 */
export function IsNegative(...items) {
    return items.every($ => typeof $ === 'number' && IsNum($) && $ < 0);
}
/**
 ...
 * ```
 */
export function IsNonZero(...items) {
    return items.every($ => typeof $ === 'number' && IsNum($) && Math.abs($) >= 1e-14);
}
/**
...
export function IsBetween(min, max) {
    return (...items) => items.every($ => typeof $ === 'number' && IsNum($) && $ >= min && $ <= max);
}
/**
 ...
 * ```
 */
export function IsAbsBetween(min, max) {
    return (...items) => items.every($ => typeof $ === 'number' && IsBetween(min, max)(Math.abs($)));
}
/**
 ...
 * ```
 */
export function IsAroundPoint(anchor, range) {
 ...
 * ```
 */
export function IsTriangle(...triangles) {
    return triangles.every(([a, b, c]) => a > 0 && b > 0 && c > 0 && a + b > c && b + c > a && c + a > b);
}
