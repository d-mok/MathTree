 ...
 * ```
 */
export function CosineLawLength(a, b, C) {
 ...
 * ```
 */
export function CosineLawAngle(a, b, c) {
 ...
 * ```
 */
export function SineLawLength(A, a, B) {
 ...
 * ```
 */
export function SineLawAngle(a, A, b) {
 ...
 * ```
 */
export function SolveSSS(a, b, c) {
 ...
 * ```
 */
export function SolveSAS(a, C, b) {
 ...
 * ```
 */
export function SolveAAS(A, B, a) {
    let C = 180 - A - B;
 ...
 * ```
 */
export function SolveASA(A, c, B) {
    let C = 180 - A - B;
 ...
 * ```
 */
export function SolveSSA(a, b, A) {
 ...
 * ```
 */
export function HeightsBySSS(a, b, c) {
 ...
 * ```
 */
export function HeightBySSS(a, b, c) {
    let area = Heron(a, b, c);
    return (2 * area) / a;
}
/**
 ...
 * ```
 */
export function HeightsBySAS(a, C, b) {
 ...
 * ```
 */
export function HeightBySAS(a, C, b) {
 ...
 * ```
 */
export function TriangleFromVertex(A, B, C, fix = true) {
 ...
 * ```
 */
export function TriangleFromPoint(A, B, C, fix = true) {
    let sideA = Distance(B, C);
    let sideB = Distance(C, A);
    let sideC = Distance(A, B);
    let angleA = CosineLawAngle(sideB, sideC, sideA);
 ...
 * ```
 */
export function SolveTriangle({ sideA, sideB, sideC, angleA, angleB, angleC, }) {
    let a = sideA;
    let b = sideB;
    let c = sideC;
    let A = angleA;
 ...
 * ```
 */
export function Orthocentre(A, B, C) {
    let H = PdFoot(C, [A, B]);
    let G = PdFoot(A, [B, C]);
    return Intersection(C, H, A, G);
}
/**
 ...
 * ```
 */
export function Incentre(A, B, C) {
    let a = Distance(B, C);
    let b = Distance(A, C);
    let c = Distance(A, B);
    let p = a + b + c;
 ...
 */
export function ScaleOrthocentreToInt(A, B, C) {
 ...
 */
export function ScaleCircumcentreToInt(A, B, C) {
 ...
 */
export function ScaleCentroidToInt(A, B, C) {
 ...
 */
export function ScaleIncentreToInt(A, B, C) {
 ...
 * ```
 */
function ratioFactor(...nums) {
    let clone = nums.unmatch([0]);
    if (clone.length === 0)
        return NaN;
    if (nums.some($ => !IsRational($)))
        return NaN;
