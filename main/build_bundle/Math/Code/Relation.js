 ...
 * ```
 */
export function AreDistinct(...nums) {
    nums = nums.map($ => $.blur());
 ...
 * ```
 */
export function AreAbsDistinct(...nums) {
 ...
 * ```
 */
export function AreSameSign(...nums) {
 ...
 * ```
 */
export function AreCoprime(...nums) {
    nums = nums.map($ => $.blur());
    if (!IsInteger(...nums))
        return true;
    if (!IsNonZero(...nums))
 ...
 * ```
 */
export function AreDistantPoint(distance) {
 ...
 * ```
 */
export function AreOblique(minAngle) {
 ...
 * ```
 */
export function AreDifferent(...items) {
