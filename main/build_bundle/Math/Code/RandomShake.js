...
function shake(anchor, shaker, ...coherentPred) {
 ...
 * ```
 */
export function RndShake(anchor) {
 ...
 * ```
 */
export function RndShakeN(anchor) {
 ...
 * ```
 */
export function RndShakeR(anchor) {
 ...
 * ```
 */
export function RndShakeQ(anchor) {
 ...
 * ```
 */
export function RndShakeG(anchor, base) {
 ...
 * ```
 */
export function RndShakeIneq(anchor) {
 ...
 * ```
 */
export function RndShakePoint(anchor) {
 ...
 * ```
 */
export function RndShakeCombo(anchor) {
    let [a, b, c] = anchor;
 ...
 * ```
 */
export function RndShakeTrig(anchor) {
    return _.sampleSize(['sin', 'cos', 'tan'], 3);
}
/**
 ...
 * ```
 */
export function RndShakeTrigValue(anchor) {
 ...
 * ```
 */
export function RndShakeRatio(anchor) {
 ...
 * ```
 */
export function RndShakeBase(anchor) {
 ...
 * ```
 */
export function RndShakePointPolar(anchor) {
 ...
 * ```
 */
export function RndShakeConstraint(anchor) {
 ...
 * ```
 */
export function RndShakeConstraints(anchor) {
    return shake(anchor, ShakeConstraints);
}
export function RndShakeQuantity(anchor) {
    return shake(anchor, ShakeQuantity);
}
export function RndShakeCompoundInequality(anchor) {
