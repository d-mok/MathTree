 ...
 * ```
 */
export function ChessboardDistance(A, B) {
    let x = Abs(A[0] - B[0]);
    let y = Abs(A[1] - B[1]);
    return Max(x, y);
}
 ...
 * ```
 */
export function Slide(P, vec, ratioA = 1, ratioB = 1 - ratioA) {
 ...
 * ```
 */
export function Rotate(P, q, O = [0, 0]) {
 ...
 * ```
 */
export function Move(P, dir, distance) {
    let q = 0;
 ...
 * ```
 */
export function MoveX(P, distance) {
    let [x, y] = P;
    return [x + distance, y];
}
/**
 ...
 * ```
 */
export function MoveY(P, distance) {
    let [x, y] = P;
    return [x, y + distance];
}
/**
 ...
 * ```
 */
export function IntersectAngle(slope1, slope2) {
...
export function Angle(A, O, B) {
    if (Object.isEqual(A, O))
        return NaN;
    if (Object.isEqual(B, O))
        return NaN;
 ...
 * ```
 */
export function AnglePolar(A, O, B) {
    if (Object.isEqual(A, O))
        return NaN;
    if (Object.isEqual(B, O))
        return NaN;
 ...
 * ```
 */
export function IsReflex(A, O, B) {
    if (Object.isEqual(A, O))
        return false;
    if (Object.isEqual(B, O))
        return false;
 ...
 * ```
 */
export function RegularPolygon(n, center, radius, startAngle) {
    let a = 360 / n;
    let arr = [];
    for (let i = 0; i < n; i++) {
 ...
 * ```
 */
export function ArcLength(radius, theta) {
 ...
 * ```
 */
export function SectorArea(radius, theta) {
 ...
 * ```
 */
export function ArrangePoints(...points) {
 ...
 * ```
 */
export function OnCircle(angle) {
