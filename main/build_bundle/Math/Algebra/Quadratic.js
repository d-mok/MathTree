 ...
 * ```
 */
export function QuadraticRoot(a, b, c) {
    if (a === 0)
        return [NaN, NaN];
 ...
 * ```
 */
export function QuadraticVertex(a, b, c) {
    if (a === 0)
        return [NaN, NaN];
    const h = -b / (2 * a);
    const k = a * h * h + b * h + c;
 ...
 * ```
 */
export function QuadraticFromRoot(a, p, q) {
    if (a === 0)
        return [NaN, NaN, NaN];
 ...
 * ```
 */
export function QuadraticFromVertex(a, h, k) {
    if (a === 0)
        return [NaN, NaN, NaN];
    const b = -2 * a * h;
    const c = k - a * h * h - b * h;
