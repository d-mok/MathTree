...
function addRule(pattern, sch, fn) {
...
addRule('*!@', schema.point2D, ([a, b]) => '(' + ink.printSurd(a) + ',' + ink.printSurd(b) + ')');
...
addRule('*@', schema.quantity, ({ val, unit }) => String(numberDefault(val)) + unit);
