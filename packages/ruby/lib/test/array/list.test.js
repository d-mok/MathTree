...
describe('chunk', () => {
    it('returns the array of chunks', () => {
        expect(list(1, 2, 3, 4, 5, 6).chunk(2))
            .toStrictEqual(list(list(1, 2), list(3, 4), list(5, 6)));
    });
    it('handles uneven remainings', () => {
        expect(list(1, 2, 3, 4, 5, 6, 7, 8).chunk(3))
            .toStrictEqual(list(list(1, 2, 3), list(4, 5, 6), list(7, 8)));
    });
...
describe('split', () => {
    it('returns the array of chunks', () => {
        expect(list(1, 2, 3, 0, 4, 5, 0, 0, 6).split(0))
            .toStrictEqual(list(list(1, 2, 3), list(4, 5), list(), list(6)));
        list(0, 1, 2, 3, 0, 4, 5, 0, 0, 6, 0).split(0); //?
        expect(list(0, 1, 2, 3, 0, 4, 5, 0, 0, 6, 0).split(0))
            .toStrictEqual(list(list(), list(1, 2, 3), list(4, 5), list(), list(6), list()));
        expect(list(1, 0, 0, 0, 2).split(0))
            .toStrictEqual(list(list(1), list(), list(), list(2)));
        expect(list(0).split(0))
            .toStrictEqual(list(list(), list()));
        expect(list().split(0))
...
describe('permutations', () => {
    it('returns a list of permutations', () => {
        ...
        expect(list(1, 2).permutations())
            .toStrictEqual(list(list(1, 2), list(2, 1)));
        expect(list(1, 2, 3).permutations())
            .toStrictEqual(list(list(1, 2, 3), list(1, 3, 2), list(2, 1, 3), list(2, 3, 1), list(3, 1, 2), list(3, 2, 1)));
