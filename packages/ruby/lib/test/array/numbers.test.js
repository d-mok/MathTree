...
describe("divide", () => {
    it("returns the divided array", () => {
        expect(numbers(1, 2, 3).divide([4, 5, 6])).toStrictEqual(numbers(0.25, 0.4, 0.5));
...
describe("toPower", () => {
    it("returns the power array", () => {
        expect(numbers(1, 2, 3).toPower([4, 5, 6])).toStrictEqual(numbers(1, 32, 729));
...
describe("blur", () => {
    it("returns the blurred value array", () => {
        expect(numbers(0.1 + 0.2, 0.81 - 1, 1.1 ** 2).blur()).toStrictEqual(numbers(0.3, -0.19, 1.21));
    });
...
describe("toFraction", () => {
    it("returns the fraction array", () => {
        expect(numbers(0.5, -456 / 123).toFraction()).toStrictEqual(list([1, 2], [-152, 41]));
    });
...
describe("reduceRatio", () => {
    it("returns the reduced ratio", () => {
        ...
        expect(numbers(2172, 4344, -2715, -5973).reduceRatio()).toStrictEqual(numbers(4, 8, -5, -11));
    ...
    it("returns a clone if contains non-integer", () => {
        expect(numbers(Math.sqrt(2), 3).reduceRatio()).toStrictEqual(numbers(Math.sqrt(2), 3));
        expect(numbers(1.5, 2.5, 3.5).reduceRatio()).toStrictEqual(numbers(1.5, 2.5, 3.5));
        expect(numbers(5, 10, 5.1).reduceRatio()).toStrictEqual(numbers(5, 10, 5.1));
        expect(numbers(1 / 3, 1 / 2, 1 / 4).reduceRatio()).toStrictEqual(numbers(1 / 3, 1 / 2, 1 / 4));
    });
...
describe("ratio", () => {
    it("returns the ratio", () => {
        ...
        expect(numbers(2172, 4344, -2715, -5973).ratio()).toStrictEqual(numbers(4, 8, -5, -11));
        expect(numbers(1.5, 2.5, 3.5).ratio()).toStrictEqual(numbers(3, 5, 7));
        expect(numbers(1.23, 4.56, 7.89).ratio()).toStrictEqual(numbers(41, 152, 263));
        expect(numbers(5, 10, 5.1).ratio()).toStrictEqual(numbers(50, 100, 51));
        expect(numbers(1 / 3, 1 / 2, 1 / 4).ratio()).toStrictEqual(numbers(4, 6, 3));
        expect(numbers(25 / 12, 13 / 64, -87 / 34).ratio()).toStrictEqual(numbers(6800, 663, -8352));
    ...
    it("returns a clone if contains irrational", () => {
        expect(numbers(Math.sqrt(2), 3).ratio()).toStrictEqual(numbers(Math.sqrt(2), 3));
    });
