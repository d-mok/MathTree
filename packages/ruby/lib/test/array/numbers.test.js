...
function it_preserve_original_numbers(func) {
...
describe('add', () => {
    it('returns the added array', () => {
        expect(numbers(1, 2, 3).add([4, 5, 6]))
            .toStrictEqual(numbers(5, 7, 9));
        expect(numbers(1, 2, 3).add(1))
            .toStrictEqual(numbers(2, 3, 4));
    });
...
describe('minus', () => {
    it('returns the subtracted array', () => {
        expect(numbers(4, 5, 6).minus([1, 2, 3]))
            .toStrictEqual(numbers(3, 3, 3));
        expect(numbers(4, 5, 6).minus(1))
            .toStrictEqual(numbers(3, 4, 5));
    });
...
describe('times', () => {
    it('returns the multiplied array', () => {
        expect(numbers(1, 2, 3).times([4, 5, 6]))
            .toStrictEqual(numbers(4, 10, 18));
        expect(numbers(1, 2, 3).times(2))
            .toStrictEqual(numbers(2, 4, 6));
    });
...
describe('divide', () => {
    it('returns the divided array', () => {
        expect(numbers(1, 2, 3).divide([4, 5, 6]))
            .toStrictEqual(numbers(0.25, 0.4, 0.5));
        expect(numbers(1, 2, 3).divide(2))
            .toStrictEqual(numbers(0.5, 1, 1.5));
    });
...
describe('toPower', () => {
    it('returns the power array', () => {
        expect(numbers(1, 2, 3).toPower([4, 5, 6]))
            .toStrictEqual(numbers(1, 32, 729));
        expect(numbers(-1, 2, 3).toPower(2))
            .toStrictEqual(numbers(1, 4, 9));
    });
...
describe('rootNth', () => {
    it('returns the root array', () => {
        expect(numbers(1, 8, 9).rootNth([4, 3, 2]))
            .toStrictEqual(numbers(1, 2, 3));
        expect(numbers(1, 4, 9).rootNth(2))
            .toStrictEqual(numbers(1, 2, 3));
    });
...
describe('squareRoot', () => {
    it('returns the square root array', () => {
        expect(numbers(1, 4, 9).squareRoot())
            .toStrictEqual(numbers(1, 2, 3));
    });
...
describe('blur', () => {
    it('returns the blurred value array', () => {
        expect(numbers(0.1 + 0.2, 0.81 - 1, 1.1 ** 2).blur())
            .toStrictEqual(numbers(0.3, -0.19, 1.21));
    });
...
describe('toFraction', () => {
    it('returns the fraction array', () => {
        expect(numbers(0.5, -456 / 123).toFraction())
            .toStrictEqual(list([1, 2], [-152, 41]));
    });
    it_preserve_original_numbers($ => $.toFraction());
});
describe('gaps', () => {
    it('returns the gaps', () => {
        expect(numbers(1, 7, 3, 20).gaps())
            .toStrictEqual(numbers(2, 4, 13));
    });
...
describe('gapsMod', () => {
    it('returns the gaps by mod', () => {
        expect(numbers(1, 7, 3, 20).gapsMod(9))
            .toStrictEqual(numbers(1, 1, 4, 3));
        expect(numbers(1, 7, 3, -20).gapsMod(9))
            .toStrictEqual(numbers(2, 4, 0, 3));
    });
...
describe('reduceRatio', () => {
    it('returns the reduced ratio', () => {
        expect(numbers(1, 2, 3).reduceRatio())
            .toStrictEqual(numbers(1, 2, 3));
        expect(numbers(4, 6, 8).reduceRatio())
            .toStrictEqual(numbers(2, 3, 4));
        expect(numbers(24, 36, -60).reduceRatio())
            .toStrictEqual(numbers(2, 3, -5));
        expect(numbers(2172, 4344, -2715, -5973).reduceRatio())
            .toStrictEqual(numbers(4, 8, -5, -11));
        expect(numbers(1, 1).reduceRatio())
            .toStrictEqual(numbers(1, 1));
        expect(numbers(0, 3, -6).reduceRatio())
            .toStrictEqual(numbers(0, 1, -2));
        expect(numbers(0, 0, 6).reduceRatio())
            .toStrictEqual(numbers(0, 0, 1));
        expect(numbers(30).reduceRatio())
            .toStrictEqual(numbers(1));
        expect(numbers(0, 0, 0).reduceRatio())
            .toStrictEqual(numbers(0, 0, 0));
    });
    it('returns a clone if contains non-integer', () => {
        expect(numbers(Math.sqrt(2), 3).reduceRatio())
            .toStrictEqual(numbers(Math.sqrt(2), 3));
        expect(numbers(1.5, 2.5, 3.5).reduceRatio())
            .toStrictEqual(numbers(1.5, 2.5, 3.5));
        expect(numbers(5, 10, 5.1).reduceRatio())
            .toStrictEqual(numbers(5, 10, 5.1));
        expect(numbers(1 / 3, 1 / 2, 1 / 4).reduceRatio())
            .toStrictEqual(numbers(1 / 3, 1 / 2, 1 / 4));
    });
...
describe('ratio', () => {
    it('returns the ratio', () => {
        expect(numbers(1, 2, 3).ratio())
            .toStrictEqual(numbers(1, 2, 3));
        expect(numbers(4, 6, 8).ratio())
            .toStrictEqual(numbers(2, 3, 4));
        expect(numbers(24, 36, -60).ratio())
            .toStrictEqual(numbers(2, 3, -5));
        expect(numbers(2172, 4344, -2715, -5973).ratio())
            .toStrictEqual(numbers(4, 8, -5, -11));
        expect(numbers(1.5, 2.5, 3.5).ratio())
            .toStrictEqual(numbers(3, 5, 7));
        expect(numbers(1.23, 4.56, 7.89).ratio())
            .toStrictEqual(numbers(41, 152, 263));
        expect(numbers(5, 10, 5.1).ratio())
            .toStrictEqual(numbers(50, 100, 51));
        expect(numbers(1 / 3, 1 / 2, 1 / 4).ratio())
            .toStrictEqual(numbers(4, 6, 3));
        expect(numbers(25 / 12, 13 / 64, -87 / 34).ratio())
            .toStrictEqual(numbers(6800, 663, -8352));
        expect(numbers(1, 1).ratio())
            .toStrictEqual(numbers(1, 1));
        expect(numbers(0, 3, -6).ratio())
            .toStrictEqual(numbers(0, 1, -2));
        expect(numbers(0, 0, 6).ratio())
            .toStrictEqual(numbers(0, 0, 1));
        expect(numbers(30).ratio())
            .toStrictEqual(numbers(1));
        expect(numbers(0, 0, 0).ratio())
            .toStrictEqual(numbers(0, 0, 0));
    });
    it('returns a clone if contains irrational', () => {
        expect(numbers(Math.sqrt(2), 3).ratio())
            .toStrictEqual(numbers(Math.sqrt(2), 3));
    });
...
describe('ratioFactor', () => {
    it('returns the ratio factor', () => {
        expect(numbers(1, 2, 3).ratioFactor())
            .toBe(1);
        expect(numbers(4, 6, 8).ratioFactor())
            .toBe(0.5);
        expect(numbers(24, 36, -60).ratioFactor())
            .toBe(1 / 12);
        expect(numbers(2172, 4344, -2715, -5973).ratioFactor())
            .toBe(1 / 543);
        expect(numbers(1.5, 2.5, 3.5).ratioFactor())
            .toBe(2);
        expect(numbers(1.23, 4.56, 7.89).ratioFactor())
            .toBe(100 / 3);
        expect(numbers(5, 10, 5.1).ratioFactor())
            .toBe(10);
        expect(numbers(1 / 3, 1 / 2, 1 / 4).ratioFactor())
            .toBe(12);
        expect(numbers(25 / 12, 13 / 64, -87 / 34).ratioFactor())
            .toBe(3264);
        expect(numbers(1, 1).ratioFactor())
            .toBe(1);
        expect(numbers(0, 3, -6).ratioFactor())
            .toBe(1 / 3);
        expect(numbers(0, 0, 6).ratioFactor())
            .toBe(1 / 6);
        expect(numbers(30).ratioFactor())
            .toBe(1 / 30);
        expect(numbers(0, 0, 0).ratioFactor())
            .toBeNaN();
    });
    it('returns NaN if contains irrational', () => {
        expect(numbers(Math.sqrt(2), 3).ratioFactor())
            .toBeNaN();
    });
