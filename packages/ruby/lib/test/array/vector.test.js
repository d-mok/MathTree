...
//     expect(vector(1, 2, 3).unit()).toStrictEqual(
//       vector(1 / Math.sqrt(14), 2 / Math.sqrt(14), 3 / Math.sqrt(14))
//     );
//     expect(vector(1, -2, 4, 10).unit()).toStrictEqual(
//       vector(1 / 11, -2 / 11, 4 / 11, 10 / 11)
//     );
//   });
...
//     expect(vector(1, 2, 3).scaledTo(2)).toStrictEqual(
//       vector(2 / Math.sqrt(14), 4 / Math.sqrt(14), 6 / Math.sqrt(14))
//     );
//     expect(vector(1, -2, 4, 10).scaledTo(-3)).toStrictEqual(
//       vector(-3 / 11, 6 / 11, -12 / 11, -30 / 11)
//     );
...
//     expect(vector(1, 2, 3).normalTo([4, 5, 6])).toBeDeepCloseTo(
//       vector(-0.6623, -0.07792, 0.5065),
//       4
//     );
//     expect(vector(5, -7, -2).normalTo([-1, 9, 3])).toBeDeepCloseTo(
//       vector(4.1868, 0.319, 0.4396),
//       3
//     );
...
//     expect(vector(10, 20, 30).extrudeTo([0, 0, 0], 0.1)).toStrictEqual(
//       vector(1, 2, 3)
//     );
//     expect(vector(-2, 3, -4).extrudeTo([2, 11, 12], 0.25)).toStrictEqual(
//       vector(1, 9, 8)
//     );
//   });
