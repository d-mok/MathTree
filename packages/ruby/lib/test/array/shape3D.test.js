...
describe("projectTo2D", () => {
    it("return the projected 2D shape", () => {
        expect(shape3D([0, 0, 0], [3, 4, 5]).projectTo2D(60, 0.5)).toBeDeepCloseTo(shape2D([0, 0], [4, 6.732050807568877]));
        expect(shape3D([0, 0, 0], [3, 4, 5]).projectTo2D(40, 1)).toBeDeepCloseTo(shape2D([0, 0], [6.064177772475912, 7.571150438746157]));
        expect(shape3D([0, 0, 0], [3, 4, 5]).projectTo2D(90, 2)).toBeDeepCloseTo(shape2D([0, 0], [3, 13]));
    });
