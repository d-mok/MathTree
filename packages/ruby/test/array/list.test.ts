...
function it_preserve_original_list(func: (_: List<any>) => any) {
    it('preserve original list', () => {
        let ls = list<any>(2, 2, 3, 1, 1, 1, 'c', 'a', true)
        let clone = list<any>(2, 2, 3, 1, 1, 1, 'c', 'a', true)
        func(ls)
        expect(ls).toStrictEqual(clone)
    })
}

function it_propagate_subclass_type(func: (_: List<any>) => any) {
...
function it_propagate_empty_list(func: (_: List<any>) => any) {
...
describe('clone', () => {
    it('returns a clone', () => {
        expect(list(1, 2, 3).clone())
            .toStrictEqual(list(1, 2, 3))
    })
...
describe('head', () => {
    it('returns the first n elements', () => {
        expect(list(7, 2, 4, 3, 1).head(3))
            .toStrictEqual(list(7, 2, 4))
    })
    it('returns all elements if n > length', () => {
        expect(list(7, 2, 4, 3, 1).head(10))
            .toStrictEqual(list(7, 2, 4, 3, 1))
    })

    it('returns empty array if n <= 0', () => {
        expect(list(7, 2, 4, 3, 1).head(0))
            .toStrictEqual(list())
        expect(list(7, 2, 4, 3, 1).head(-1))
            .toStrictEqual(list())
    })
...
describe('tail', () => {
    it('returns the last n elements', () => {
        expect(list(7, 2, 4, 3, 1).tail(3))
            .toStrictEqual(list(4, 3, 1))
    })
    it('returns all elements if n > length', () => {
        expect(list(7, 2, 4, 3, 1).tail(10))
            .toStrictEqual(list(7, 2, 4, 3, 1))
    })

    it('returns empty array if n <= 0', () => {
        expect(list(7, 2, 4, 3, 1).tail(0))
            .toStrictEqual(list())
        expect(list(7, 2, 4, 3, 1).tail(-1))
            .toStrictEqual(list())
    })
...
describe('before', () => {
    it('returns the elements before index', () => {
        expect(list(7, 2, 4, 3, 1).before(3))
            .toStrictEqual(list(7, 2, 4))
    })
    it('returns all elements if index >= length', () => {
        expect(list(7, 2, 4, 3, 1).before(5))
            .toStrictEqual(list(7, 2, 4, 3, 1))
    })
...
describe('till', () => {
    it('returns the elements till index', () => {
        expect(list(7, 2, 4, 3, 1).till(3))
            .toStrictEqual(list(7, 2, 4, 3))
        expect(list(7, 2, 4, 3, 1).till(0))
            .toStrictEqual(list(7))
    })
    it('returns all elements if index >= length-1', () => {
        expect(list(7, 2, 4, 3, 1).till(4))
            .toStrictEqual(list(7, 2, 4, 3, 1))
        expect(list(7, 2, 4, 3, 1).till(5))
            .toStrictEqual(list(7, 2, 4, 3, 1))
    })
    it('returns empty array if index < 0', () => {
...
describe('after', () => {
    it('returns the elements after index', () => {
        expect(list(7, 2, 4, 3, 1).after(2))
            .toStrictEqual(list(3, 1))
        expect(list(7, 2, 4, 3, 1).after(0))
            .toStrictEqual(list(2, 4, 3, 1))
    })
    it('returns empty array if index >= length-1', () => {
        expect(list(7, 2, 4, 3, 1).after(4))
            .toStrictEqual(list())
    })
    it('returns all elements if index < 0', () => {
        expect(list(7, 2, 4, 3, 1).after(-1))
            .toStrictEqual(list(7, 2, 4, 3, 1))
    })
...
describe('since', () => {
    it('returns the elements since index', () => {
        expect(list(7, 2, 4, 3, 1).since(2))
            .toStrictEqual(list(4, 3, 1))
        expect(list(7, 2, 4, 3, 1).since(0))
            .toStrictEqual(list(7, 2, 4, 3, 1))
    })
    it('returns empty array if index > length-1', () => {
        expect(list(7, 2, 4, 3, 1).since(5))
            .toStrictEqual(list())
    })
    it('returns all elements if index <= 0', () => {
        expect(list(7, 2, 4, 3, 1).since(0))
            .toStrictEqual(list(7, 2, 4, 3, 1))
        expect(list(7, 2, 4, 3, 1).since(-1))
            .toStrictEqual(list(7, 2, 4, 3, 1))
    })
...
describe('chunk', () => {
    it('returns the array of chunks', () => {
        expect(list(1, 2, 3, 4, 5, 6).chunk(2))
            .toStrictEqual(list(
                list(1, 2),
                list(3, 4),
                list(5, 6)
    ...
    it('handles uneven remainings', () => {
        expect(list(1, 2, 3, 4, 5, 6, 7, 8).chunk(3))
            .toStrictEqual(list(
                list(1, 2, 3),
                list(4, 5, 6),
                list(7, 8)
    ...
    it('returns empty array if size=0', () => {
        expect(list(1, 2, 3, 4, 5, 6, 7, 8).chunk(0))
            .toStrictEqual(list())
    })
...
describe('split', () => {
    it('returns the array of chunks', () => {
        expect(list(1, 2, 3, 0, 4, 5, 0, 0, 6).split(0))
            .toStrictEqual(list(
                list(1, 2, 3),
                list(4, 5),
                list(),
        ...
        expect(list(0, 1, 2, 3, 0, 4, 5, 0, 0, 6, 0).split(0))
            .toStrictEqual(list(
                list(),
                list(1, 2, 3),
                list(4, 5),
...
describe('unique', () => {
    it('returns a unique list', () => {
        expect(list(2, 2, 3, 1, 1, 1).unique())
            .toStrictEqual(list(2, 3, 1))
        expect(list([1, 2], [1, 2], [3, 4]).unique())
            .toStrictEqual(list([1, 2], [1, 2], [3, 4]))
        expect(list([2], [2], [3], [1], [1], [1]).unique())
            .toStrictEqual(list([2], [2], [3], [1], [1], [1]))
    })
...
describe('uniqueBy', () => {
    it('returns a unique list', () => {
        expect(list(2, 2, 3, 1, 1, 1).uniqueBy(Math.floor))
            .toStrictEqual(list(2, 3, 1))
        expect(list(1.1, 1.2, 3.5, 3.4, 6.7).uniqueBy(Math.floor))
            .toStrictEqual(list(1.1, 3.5, 6.7))
        expect(list([1, 2], [1, 2], [3, 4]).uniqueBy($ => JSON.stringify($)))
            .toStrictEqual(list([1, 2], [3, 4]))
...
describe('uniqueDeep', () => {
    it('returns a unique list', () => {
        expect(list(2, 2, 3, 1, 1, 1).uniqueDeep())
            .toStrictEqual(list(2, 3, 1))
        expect(list([2], [2], [3], [1], [1], [1]).uniqueDeep())
            .toStrictEqual(list([2], [3], [1]))
        expect(list(1.1, 1.2, 3.5, 3.4, 6.7).uniqueDeep())
            .toStrictEqual(list(1.1, 1.2, 3.5, 3.4, 6.7))
        expect(list([1, 2], [1, 2], [3, 4]).uniqueDeep())
            .toStrictEqual(list([1, 2], [3, 4]))
    })
    it_propagate_empty_list($ => $.uniqueBy(Math.floor))
    it_propagate_subclass_type($ => $.uniqueBy(Math.floor))
...
describe('distincts', () => {
    it('returns a list of distinct elements', () => {
        expect(list(1, 2, 2, 3, 4, 4, 4).distincts())
            .toStrictEqual(list(1, 3))
    })
...
describe('duplicates', () => {
    it('returns a list of duplicates elements', () => {
        expect(list(1, 2, 2, 3, 4, 4, 4).duplicates())
            .toStrictEqual(list(2, 2, 4, 4, 4))
    })
...
describe('duplicated', () => {
    it('returns a list of duplicated elements', () => {
        expect(list(1, 2, 2, 3, 4, 4, 4).duplicated())
            .toStrictEqual(list(2, 4))
    })
...
describe('violate', () => {
    it('returns the violated', () => {
        expect(list(1, 2, 4, 3).violate($ => $ % 2 === 0))
            .toStrictEqual(list(1, 3))
    })
...
describe('inside', () => {
    it('returns the insiders', () => {
        expect(list(1, 2, 4, 3).inside([2, 5, 1]))
            .toStrictEqual(list(1, 2))
    })
    it('works for empty supply', () => {
        expect(list(1, 2, 4, 3).inside([]))
            .toStrictEqual(list())
    })
...
describe('except', () => {
    it('returns the remaining', () => {
        expect(list(1, 2, 4, 3).except([2, 5, 1]))
            .toStrictEqual(list(4, 3))
    })
    it('works for empty exception', () => {
        expect(list(1, 2, 4, 3).except([]))
            .toStrictEqual(list(1, 2, 4, 3))
    })
...
describe('filterIndex', () => {
    it('returns the filtered array', () => {
        expect(list('a', 'b', 'c', 'd', 'e', 'f').filterIndex($ => $ % 2 === 0))
            .toStrictEqual(list('a', 'c', 'e'))
    })
    it('works for empty exception', () => {
        expect(list(1, 2, 4, 3).except([]))
            .toStrictEqual(list(1, 2, 4, 3))
...
describe('reversed', () => {
    it('returns a reversed list', () => {
        expect(list(1, 2, 4, 3).reversed())
            .toStrictEqual(list(3, 4, 2, 1))
    })
...
describe('ascending', () => {
    it('returns a ascending list', () => {
        expect(list(1, 2, 4, 3).ascending())
            .toStrictEqual(list(1, 2, 3, 4))
        expect(list(1, 2, 23, 14).ascending())
            .toStrictEqual(list(1, 2, 14, 23))
        expect(list('a', 'c', 'b', 'd').ascending())
            .toStrictEqual(list('a', 'b', 'c', 'd'))
    })
...
describe('descending', () => {
    it('returns a descending list', () => {
        expect(list(1, 2, 4, 3).descending())
            .toStrictEqual(list(4, 3, 2, 1))
        expect(list(1, 2, 23, 14).descending())
            .toStrictEqual(list(23, 14, 2, 1))
        expect(list('a', 'c', 'b', 'd').descending())
            .toStrictEqual(list('d', 'c', 'b', 'a'))
    })
...
describe('sorted', () => {
    const evenFirst = (a: number, b: number) => a % 2 - b % 2
    const desc = (a: number, b: number) => b - a
    it('returns a sorted array', () => {
        let ls = list(3, 8, 5, 7, 4, 9, 6, 1, 2, 0)
        expect(ls.sorted(evenFirst, desc)).
            toStrictEqual(list(8, 6, 4, 2, 0, 9, 7, 5, 3, 1))
    })

    it('sorts stably', () => {
        let ls = list(3, 8, 5, 7, 4, 9, 6, 1, 2, 0)
        expect(ls.sorted(evenFirst))
            .toStrictEqual(list(8, 4, 6, 2, 0, 3, 5, 7, 9, 1))
    })
...
describe('sortedBy', () => {
    it('returns a sorted number array', () => {
        ...
        expect(ls.sortedBy(parity, negative))
            .toStrictEqual(list(8, 6, 4, 2, 0, 9, 7, 5, 3, 1))
    })
    it('returns a sorted string array', () => {
        ...
        expect(ls.sortedBy(length, initial))
            .toStrictEqual(list('d', 'cc', 'dd', 'ee', 'ddd'))
        expect(ls.sortedBy(initial, length))
            .toStrictEqual(list('cc', 'd', 'dd', 'ddd', 'ee'))
    })
...
describe('sortedByFreq', () => {
    it('returns a sorted number array', () => {
        ...
        expect(ls.sortedByFreq())
            .toStrictEqual(list(6, 6, 6, 7, 7, 5, 8))
    })

    it('returns a sorted string array', () => {
        let ls = list('d', 'd', 'd', 'e', 'c', 'e', 'f')
        expect(ls.sortedByFreq())
            .toStrictEqual(list('d', 'd', 'd', 'e', 'e', 'c', 'f'))
    })
...
describe('combinations', () => {
    it('returns a list of combinations', () => {
        ...
        expect(ls.combinations(1)).toStrictEqual(list(
            list(1),
            list(2),
            list(3),
            list(4)
        ))
        expect(ls.combinations(2)).toStrictEqual(list(
            list(1, 2),
            list(1, 3),
            list(1, 4),
            list(2, 3),
        ...
        expect(ls.combinations(3)).toStrictEqual(list(
            list(1, 2, 3),
            list(1, 2, 4),
            list(1, 3, 4),
            list(2, 3, 4),
        ))
        expect(ls.combinations(4)).toStrictEqual(list(
            list(1, 2, 3, 4)
        ))
    })
...
describe('pairs', () => {
    it('returns a list of apirs', () => {
        let ls = list(1, 2, 3, 4)
        expect(ls.pairs()).toStrictEqual(list(
            list(1, 2),
            list(1, 3),
            list(1, 4),
            list(2, 3),
...
describe('permutations', () => {
    it('returns a list of permutations', () => {
        expect(list().permutations())
            .toStrictEqual(list());
        expect(list(1).permutations())
            .toStrictEqual(list(list(1)));
        expect(list(1, 2).permutations())
            .toStrictEqual(list(
                list(1, 2),
                list(2, 1)
            ));
        expect(list(1, 2, 3).permutations())
            .toStrictEqual(list(
                list(1, 2, 3),
                list(1, 3, 2),
                list(2, 1, 3),
...
describe('maxsBy', () => {
    ...
    it('returns the elements at max', () => {
        ...
        expect(L1.maxsBy(length))
            .toStrictEqual(list('aaa', 'bbb', 'ddd'))
        expect(L1.maxsBy(length, 1))
            .toStrictEqual(list('aaa', 'bbb', 'ddd'))
        expect(L1.maxsBy(length, 2))
            .toStrictEqual(list('ee'))
        expect(L1.maxsBy(length, 3))
            .toStrictEqual(list('c'))
        expect(L1.maxsBy(length, 4))
            .toStrictEqual(list())

        let L2 = list(2.1, 2.3, 6.5, 4.1)
        expect(L2.maxsBy(floor))
            .toStrictEqual(list(6.5))
        expect(L2.maxsBy(floor, 1))
            .toStrictEqual(list(6.5))
        expect(L2.maxsBy(floor, 2))
            .toStrictEqual(list(4.1))
        expect(L2.maxsBy(floor, 3))
            .toStrictEqual(list(2.1, 2.3))
        expect(L2.maxsBy(floor, 4))
            .toStrictEqual(list())
    })
...
describe('minsBy', () => {
    ...
    it('returns the elements at min', () => {
        ...
        expect(L1.minsBy(length))
            .toStrictEqual(list('b', 'c'))
        expect(L1.minsBy(length, 1))
            .toStrictEqual(list('b', 'c'))
        expect(L1.minsBy(length, 2))
            .toStrictEqual(list('ee'))
        expect(L1.minsBy(length, 3))
            .toStrictEqual(list('aaa', 'ddd'))
        expect(L1.minsBy(length, 4))
            .toStrictEqual(list())

        let L2 = list(2.1, 2.3, 6.5, 4.1)
        expect(L2.minsBy(floor))
            .toStrictEqual(list(2.1, 2.3))
        expect(L2.minsBy(floor, 1))
            .toStrictEqual(list(2.1, 2.3))
        expect(L2.minsBy(floor, 2))
            .toStrictEqual(list(4.1))
        expect(L2.minsBy(floor, 3))
            .toStrictEqual(list(6.5))
        expect(L2.minsBy(floor, 4))
            .toStrictEqual(list())
    })
