...
describe("chunk", () => {
  it("returns the array of chunks", () => {
    expect(list(1, 2, 3, 4, 5, 6).chunk(2)).toStrictEqual(
      list(list(1, 2), list(3, 4), list(5, 6))
    );
  });
  it("handles uneven remainings", () => {
    expect(list(1, 2, 3, 4, 5, 6, 7, 8).chunk(3)).toStrictEqual(
...
describe("split", () => {
  it("returns the array of chunks", () => {
    expect(list(1, 2, 3, 0, 4, 5, 0, 0, 6).split(0)).toStrictEqual(
      list(list(1, 2, 3), list(4, 5), list(), list(6))
    );
    list(0, 1, 2, 3, 0, 4, 5, 0, 0, 6, 0).split(0); //?
    expect(list(0, 1, 2, 3, 0, 4, 5, 0, 0, 6, 0).split(0)).toStrictEqual(
      list(list(), list(1, 2, 3), list(4, 5), list(), list(6), list())
    );

    expect(list(1, 0, 0, 0, 2).split(0)).toStrictEqual(
      list(list(1), list(), list(), list(2))
    );
...
describe("unique", () => {
  it("returns a unique list", () => {
    ...
    expect(list([1, 2], [1, 2], [3, 4]).unique()).toStrictEqual(
      list([1, 2], [1, 2], [3, 4])
    );
    expect(list([2], [2], [3], [1], [1], [1]).unique()).toStrictEqual(
      list([2], [2], [3], [1], [1], [1])
    );
  });
...
describe("uniqueBy", () => {
  it("returns a unique list", () => {
    expect(list(2, 2, 3, 1, 1, 1).uniqueBy(Math.floor)).toStrictEqual(
      list(2, 3, 1)
    );
    expect(list(1.1, 1.2, 3.5, 3.4, 6.7).uniqueBy(Math.floor)).toStrictEqual(
      list(1.1, 3.5, 6.7)
    );
    expect(
      list([1, 2], [1, 2], [3, 4]).uniqueBy(($) => JSON.stringify($))
...
describe("uniqueDeep", () => {
  it("returns a unique list", () => {
    ...
    expect(list([2], [2], [3], [1], [1], [1]).uniqueDeep()).toStrictEqual(
      list([2], [3], [1])
    );
    expect(list(1.1, 1.2, 3.5, 3.4, 6.7).uniqueDeep()).toStrictEqual(
      list(1.1, 1.2, 3.5, 3.4, 6.7)
    );
    expect(list([1, 2], [1, 2], [3, 4]).uniqueDeep()).toStrictEqual(
      list([1, 2], [3, 4])
    );
  });
  it_propagate_empty_list(($) => $.uniqueBy(Math.floor));
...
describe("duplicates", () => {
  it("returns a list of duplicates elements", () => {
    expect(list(1, 2, 2, 3, 4, 4, 4).duplicates()).toStrictEqual(
      list(2, 2, 4, 4, 4)
    );
  });
...
describe("violate", () => {
  it("returns the violated", () => {
    expect(list(1, 2, 4, 3).violate(($) => $ % 2 === 0)).toStrictEqual(
      list(1, 3)
    );
  });
...
describe("filterIndex", () => {
  it("returns the filtered array", () => {
    expect(
      list("a", "b", "c", "d", "e", "f").filterIndex(($) => $ % 2 === 0)
...
describe("ascending", () => {
  it("returns a ascending list", () => {
    ...
    expect(list("a", "c", "b", "d").ascending()).toStrictEqual(
      list("a", "b", "c", "d")
    );
  });
...
describe("descending", () => {
  it("returns a descending list", () => {
    ...
    expect(list("a", "c", "b", "d").descending()).toStrictEqual(
      list("d", "c", "b", "a")
    );
  });
...
describe("sorted", () => {
  ...
  it("returns a sorted array", () => {
    ...
    expect(ls.sorted(evenFirst, desc)).toStrictEqual(
      list(8, 6, 4, 2, 0, 9, 7, 5, 3, 1)
    );
  });

  it("sorts stably", () => {
    let ls = list(3, 8, 5, 7, 4, 9, 6, 1, 2, 0);
    expect(ls.sorted(evenFirst)).toStrictEqual(
      list(8, 4, 6, 2, 0, 3, 5, 7, 9, 1)
    );
  });
...
describe("sortedBy", () => {
  it("returns a sorted number array", () => {
    ...
    expect(ls.sortedBy(parity, negative)).toStrictEqual(
      list(8, 6, 4, 2, 0, 9, 7, 5, 3, 1)
    );
  });
  it("returns a sorted string array", () => {
    ...
    expect(ls.sortedBy(length, initial)).toStrictEqual(
      list("d", "cc", "dd", "ee", "ddd")
    );
    expect(ls.sortedBy(initial, length)).toStrictEqual(
      list("cc", "d", "dd", "ddd", "ee")
    );
  });
...
describe("sortedByFreq", () => {
  ...
  it("returns a sorted string array", () => {
    ...
    expect(ls.sortedByFreq()).toStrictEqual(
      list("d", "d", "d", "e", "e", "c", "f")
    );
  });
...
describe("combinations", () => {
  it("returns a list of combinations", () => {
    ...
    expect(ls.combinations(1)).toStrictEqual(
      list(list(1), list(2), list(3), list(4))
    );
    expect(ls.combinations(2)).toStrictEqual(
      list(
        list(1, 2),
        list(1, 3),
        list(1, 4),
    ...
    expect(ls.combinations(3)).toStrictEqual(
...
describe("permutations", () => {
  it("returns a list of permutations", () => {
    ...
    expect(list(1, 2).permutations()).toStrictEqual(
      list(list(1, 2), list(2, 1))
    );
    expect(list(1, 2, 3).permutations()).toStrictEqual(
      list(
        list(1, 2, 3),
        list(1, 3, 2),
        list(2, 1, 3),
...
describe("padTail", () => {
  it("returns the padded array", () => {
    ...
    expect(list(1, 2, 3).padTail(10)).toStrictEqual(
      list(1, 2, 3, 3, 3, 3, 3, 3, 3, 3)
    );
...
describe("padHead", () => {
  it("returns the padded array", () => {
    ...
    expect(list(1, 2, 3).padHead(10)).toStrictEqual(
...
describe("padCyclic", () => {
  it("returns the padded array", () => {
    ...
    expect(list(1, 2, 3).padCyclic(10)).toStrictEqual(
