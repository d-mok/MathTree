...
describe("cross", () => {
  it("returns the cross product", () => {
    ...
    expect(vector3D(-2, 4, -6).cross([3, -5, 1])).toStrictEqual(
      vector3D(-26, -16, -2)
    );
...
describe("rotate", () => {
  it("returns the rotated vector", () => {
    expect(vector3D(1, 0, 0).rotate([0, 0, 1], 90)).toBeDeepCloseTo(
      vector3D(0, 1, 0)
    );
    expect(vector3D(1, 2, 3).rotate([0, 0, 1], 90)).toBeDeepCloseTo(
      vector3D(-2, 1, 3)
    );
    expect(vector3D(4, 5, 6).rotate([1, 2, 3], 50)).toBeDeepCloseTo(
      vector3D(2.7734339346, 6.0753129109, 5.6919800812)
    );
    expect(vector3D(1, 2, -3).rotate([-4, -5, 6], -120)).toBeDeepCloseTo(
      vector3D(1.6974282308, 2.7090396423, -1.9441814775)
    );
...
describe("projectOnPlane", () => {
  it("returns the vector projection", () => {
    expect(
      vector3D(3, 4, 5).projectOnPlane([1, 0, 0], [0, 1, 0])
    ).toStrictEqual(vector3D(3, 4, 0));
    expect(
      vector3D(3, 4, 5).projectOnPlane([-1, 0, 0], [0, 1, 0])
    ).toStrictEqual(vector3D(3, 4, 0));
    expect(
      vector3D(3, 2, -1).projectOnPlane([4, 1, 0], [1, 0, 3])
...
describe("normalToPlane", () => {
  it("returns the normal vector", () => {
    expect(vector3D(3, 4, 5).normalToPlane([1, 0, 0], [0, 1, 0])).toStrictEqual(
      vector3D(0, 0, 5)
    );
    expect(
      vector3D(3, 4, 5).normalToPlane([-1, 0, 0], [0, 1, 0])
    ).toStrictEqual(vector3D(-0, -0, 5));
    expect(
      vector3D(3, 2, -1).normalToPlane([4, 1, 0], [1, 0, 3])
...
describe("projectTo2D", () => {
  it("returns the projection", () => {
    expect(vector3D(3, 4, 5).projectTo2D(60, 0.5)).toBeDeepCloseTo(
      vector2D(4, 6.732050807568877)
    );
    expect(vector3D(3, 4, 5).projectTo2D(40, 1)).toBeDeepCloseTo(
      vector2D(6.064177772475912, 7.571150438746157)
    );
    expect(vector3D(3, 4, 5).projectTo2D(90, 2)).toBeDeepCloseTo(
      vector2D(3, 13)
    );
  });
