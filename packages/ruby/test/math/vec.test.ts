...
describe('normalTo', () => {
    it('returns the normal vector', () => {
        ...
        expect(vec.normal([1, 2, 3], [4, 5, 6])).toBeDeepCloseTo(
            [-0.6623, -0.07792, 0.5065],
            4
        )
        expect(vec.normal([5, -7, -2], [-1, 9, 3])).toBeDeepCloseTo(
            [4.1868, 0.319, 0.4396],
            3
        )
...
describe('projectOnPlane', () => {
    it('returns the vector projection', () => {
        expect(
            vec.projectOnPlane([3, 4, 5], [1, 0, 0], [0, 1, 0])
        ).toStrictEqual([3, 4, 0])
        expect(
            vec.projectOnPlane([3, 4, 5], [-1, 0, 0], [0, 1, 0])
        ).toStrictEqual([3, 4, 0])
        expect(
            vec.projectOnPlane([3, 2, -1], [4, 1, 0], [1, 0, 3])
        ).toBeDeepCloseTo([36 / 11, 10 / 11, -12 / 11])
    })
})
...
describe('normalToPlane', () => {
    it('returns the normal vector', () => {
        expect(
            vec.normalToPlane([3, 4, 5], [1, 0, 0], [0, 1, 0])
        ).toStrictEqual([0, 0, 5])
        expect(
            vec.normalToPlane([3, 4, 5], [-1, 0, 0], [0, 1, 0])
        ).toStrictEqual([-0, -0, 5])
        expect(
            vec.normalToPlane([3, 2, -1], [4, 1, 0], [1, 0, 3])
        ).toBeDeepCloseTo([-3 / 11, 12 / 11, 1 / 11])
    })
})
