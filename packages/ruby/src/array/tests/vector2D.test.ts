...
describe('rotate', () => {
    ...
    it('returns the rotated vector', () => {
        expect(vector2D(8, 6).rotate(90))
            .toBeDeepCloseTo(vector2D(-6, 8))
        expect(vector2D(8, 6).rotate(180))
            .toBeDeepCloseTo(vector2D(-8, -6))
        expect(vector2D(8, 6).rotate(270))
            .toBeDeepCloseTo(vector2D(6, -8))
        expect(vector2D(8, 6).rotate(360))
            .toBeDeepCloseTo(vector2D(8, 6))
        expect(vector2D(8, 6).rotate(-90))
            .toBeDeepCloseTo(vector2D(6, -8))
        expect(vector2D(1, 2).rotate(45))
            .toBeDeepCloseTo(vector2D(2 ** (-0.5) - 2 ** 0.5, 2 ** (-0.5) + 2 ** 0.5))
    })
