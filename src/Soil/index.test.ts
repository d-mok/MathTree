...
test('properly grow single seed', () => {
    ...
    expect(seeds.question!.ans).toBeUndefined();
});
...
test('properly grow array of seeds', () => {
    ...
    expect(seeds[2].question!.ans).toBeUndefined();
});
...
test('properly throw error', () => {
    ...
    MathSoil.grow(seed);
    expect(seed.question!.qn).toContain("Error!");
    expect(seed.question!.sol).toContain("Error!");
    expect(seed.question!.ans).toContain("Error!");
});
